...
public class Fractal2 implements Fractal{
    ...
    private int MAX_RECURSAO;
    Graphics g;

    public Fractal2(Graphics g){
        MAX_RECURSAO = 5;
        this.g = g;
    }
    
    public Fractal2(Graphics g, int max_r){
        MAX_RECURSAO = max_r;
        this.g = g;
    }
    ...
    public void fractal(Vector2 v1, Vector2 v2, Vector2 v3, int i){
        ...
        drawTriangle(mid(v1, v2), mid(v1, v3), mid(v2, v3));
        if(i <= MAX_RECURSAO){
            fractal(mid(v1, v2), v1, mid(v1, v3), i + 1);
            fractal(v2, mid(v1, v2), mid(v2, v3), i + 1);
            fractal(mid(v2, v3), mid(v1, v3), v3, i + 1);
        }
    }
